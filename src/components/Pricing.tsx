  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: 'Free SSL Certificates', included: false },
        { text: 'SEO Friendly Website', included: false },
        { text: '100% Responsive Website', included: false },
        { text: 'Live Chat Integration', included: false },
        { text: 'Social Media Integration', included: false },
        { text: 'Call Button Integration', included: false },
        { text: 'WhatsApp Button Integration', included: false },
        { text: 'Inquiry Form', included: false },
        { text: '1 Year Free Technical Support For Website', included: false },
        { text: 'Annual Renewal For Hosting Rs.4000.', included: false },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Woocommece Features', included: false },
        { text: 'Annual Renewal For Hosting Rs.4000.', included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Payment Gateway Integration', included: false },
        { text: 'Woocommece Features', included: false },
        { text: 'Ecommece Features', included: false },
        { text: 'Auto Invoice Bill Generater Features', included: false },
        { text: 'Order Notification Features', included: false },
        { text: 'OTP Verification Features', included: false },
        { text: 'Annual Renewal For Hosting Rs.4000.', included: false },
      ],
      buttonText: 'Contact Us',
      popular: false,
